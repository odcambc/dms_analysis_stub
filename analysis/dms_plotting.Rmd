...
```{r}
# Enrich2 score files
scores_file = "../results/main_identifiers_scores.tsv"
#scores_file = "../results_stop/main_identifiers_scores.tsv"
...
```{r}
wt_fasta = "Sequences/WT_sequence.fasta"
...
```{r}
print_heatmap(scores, score_dms_5, wt, scale = TRUE, invert_scale = TRUE, output_file = "output/heatmap_dms_5.pdf")

print_heatmap(scores, score_dms_3, wt, scale = TRUE, invert_scale = TRUE, output_file = "output/heatmap_dms_3.pdf")

print_heatmap(scores, score_dms_4, wt, scale = TRUE, invert_scale = TRUE, output_file = "output/heatmap_dms_4.pdf")

print_heatmap(scores, score_dms_1, wt, scale = TRUE, invert_scale = FALSE, output_file = "output/heatmap_dms_1.pdf")

print_heatmap(scores, score_dms_2, wt, scale = TRUE, invert_scale = FALSE, output_file = "output/heatmap_dms_2.pdf")
...
```{r}
pdb_example1 <- read.pdb("structures/example1.pdb")
pdb_example2 <- read.pdb("structures/example2.pdb")

x = map_scores_pdb(pdb_example1, avg_scores, "avg_dms_1")
write.pdb(x, file="structures/scores/example1_dms_1.pdb")
x = map_scores_pdb(pdb_example1, avg_scores, "avg_dms_2")
write.pdb(x, file="structures/scores/example1_dms_2.pdb")
x = map_scores_pdb(pdb_example1, avg_scores, "avg_dms_3")
write.pdb(x, file="structures/scores/example1_dms_3.pdb")
x = map_scores_pdb(pdb_example1, avg_scores, "avg_dms_4")
write.pdb(x, file="structures/scores/example1_dms_4.pdb")
x = map_scores_pdb(pdb_example1, avg_scores, "avg_dms_5")
write.pdb(x, file="structures/scores/example1_dms_5.pdb")

x = map_scores_pdb(pdb_example2, avg_scores, "avg_dms_1")
write.pdb(x, file="structures/scores/example2_dms_1.pdb")
x = map_scores_pdb(pdb_example2, avg_scores, "avg_dms_2")
write.pdb(x, file="structures/scores/example2_dms_2.pdb")
x = map_scores_pdb(pdb_example2, avg_scores, "avg_dms_3")
write.pdb(x, file="structures/scores/example2_dms_3.pdb")
x = map_scores_pdb(pdb_example2, avg_scores, "avg_dms_4")
write.pdb(x, file="structures/scores/example2_dms_4.pdb")
x = map_scores_pdb(pdb_example2, avg_scores, "avg_dms_5")
write.pdb(x, file="structures/scores/example2_dms_5.pdb")
```