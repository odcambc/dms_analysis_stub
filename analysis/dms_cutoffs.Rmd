...
ggsave("output/dms_B_dms_A_scatter.png", width = 5, height = 5, scores_scatter)
ggsave("output/dms_B_dms_A_scatter.pdf", width = 5, height = 5, scores_scatter)
...
dms_A_dms_C_plot <- plot_score_scatter(scores, score_dms_C, score_dms_A, 
                                       output_file = "output/dms_C_dms_A_scatter.png",
...
dms_A_dms_B_plot <- plot_score_scatter(scores, score_dms_B, score_dms_A, 
                                       output_file = "output/dms_A_dms_B_scatter.png",
